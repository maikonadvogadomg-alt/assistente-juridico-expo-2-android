# assistente-juridico-expo-2 — Projeto Android (Capacitor)

## Origem
GitHub: maikonadvogadomg-alt/assistente-juridico-expo-2@main
...
## Configuração
- **Package:** `com.github.assistentejuridicoexpo2`
- **Versão:** 1.0.0 (code: 1)
- **Min SDK:** Android 22+
- **Orientação:** portrait
